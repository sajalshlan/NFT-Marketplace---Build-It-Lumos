  ...
  return (
    <div>
      <div className="flex flex-col w-56 align-middle justify-center mx-auto mt-20  relative">
        ...
        <div className="shadow-[0px_10px_1px_rgba(221,_221,_221,_1),_0_10px_20px_rgba(204,_204,_204,_1)] p-10 rounded-xl mt-6 cursor-pointer hover:text-white hover:bg-black transition duration-700 ease-in-out">
          <Image
